...
THINGSPEAK_READ_KEY   = "T9VU037H0SE1PG8U"   # <-- your confirmed read key
...
# Optional server secret used when deriving deterministic historical keys.
# Keep it secret; change if you want keys derived differently.
