        ...
        try:
            ...
            if r.status_code == 200:
                ...
                for feed in feeds:
                    ...
                    cipher_b64 = feed.get("field1", "")
                    key_id = feed.get("field2", "")
                    iv_hex = feed.get("field3", "")
                    ...
                    try:
                        ...
                        sct = scipher.encrypt(pad(payload_json, AES.block_size))
                        sct_b64 = base64.b64encode(sct).decode()

                        doc = {"entry_id": entry_id, "server_cipher_b64": sct_b64, "server_iv_hex": server_iv.hex(), "stored_at": time.time()}
